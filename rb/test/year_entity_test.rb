...
class YearEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FOOTER_YEAR_UPDATE_TEST_YEAR_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def year_basic_setup(extra)
  ...
  entid_env_raw = ENV["FOOTER_YEAR_UPDATE_TEST_YEAR_ENTID"]
