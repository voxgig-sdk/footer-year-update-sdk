...
#      offline in seeded test mode (FooterYearUpdateSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FooterYearUpdate_sdk.rb")
  SDK_CLASS = "FooterYearUpdateSDK"
