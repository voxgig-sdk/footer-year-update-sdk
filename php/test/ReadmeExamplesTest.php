...
// FooterYearUpdate SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FooterYearUpdateSDK::test)
...
{
    private const SDK_CLASS = 'FooterYearUpdateSDK';
    ...
    private const SDK_BASE = 'footeryearupdate_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../footeryearupdate_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
