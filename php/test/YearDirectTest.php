...
{
    public function test_direct_load_year(): void
    {
        $setup = year_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-year", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
