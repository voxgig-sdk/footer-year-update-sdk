...
// FooterYearUpdate SDK pipeline test
//
...
{
    private static function utility(): FooterYearUpdateUtility
    {
        return new FooterYearUpdateUtility();
    }
    ...
    private static function ctx(array $over = []): FooterYearUpdateContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FooterYearUpdateContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FooterYearUpdateOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FooterYearUpdateError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FooterYearUpdateOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FooterYearUpdateMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FooterYearUpdateOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FooterYearUpdateMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FooterYearUpdateOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FooterYearUpdateMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FooterYearUpdateSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FooterYearUpdateMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FooterYearUpdateResponse([]),
            'result' => new FooterYearUpdateResult([]),
        ]);
        [, $err] = FooterYearUpdateMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FooterYearUpdateSpec([]),
            'response' => null,
            'result' => new FooterYearUpdateResult([]),
        ]);
        [, $err] = FooterYearUpdateMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FooterYearUpdateSpec(['step' => 's']),
            'response' => new FooterYearUpdateResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FooterYearUpdateResult([]),
        ]);
        [, $err] = FooterYearUpdateMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FooterYearUpdateSpec(['step' => 's']),
            'response' => new FooterYearUpdateResponse(self::resp(200, ['v' => 1])),
            'result' => new FooterYearUpdateResult([]),
        ]);
        [, $err] = FooterYearUpdateMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FooterYearUpdateSpec(['step' => 's']),
            'response' => new FooterYearUpdateResponse(self::resp(200, ['v' => 2])),
            'result' => new FooterYearUpdateResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FooterYearUpdateMakeResponse::call($ctx);
    ...
    {
        $preset = new FooterYearUpdateResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FooterYearUpdateSpec([]),
            'response' => new FooterYearUpdateResponse([]),
            'result' => new FooterYearUpdateResult([]),
        ...
        [$got, $err] = FooterYearUpdateMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FooterYearUpdateResult([])]);
        [, $err] = FooterYearUpdateMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FooterYearUpdateSpec([]), 'result' => null]);
        [, $err] = FooterYearUpdateMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FooterYearUpdateSpec(['step' => 's']),
            'result' => new FooterYearUpdateResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FooterYearUpdateOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FooterYearUpdateMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FooterYearUpdateSpec(['step' => 's']),
            'result' => new FooterYearUpdateResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FooterYearUpdateOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FooterYearUpdateMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FooterYearUpdateResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FooterYearUpdateSpec([]),
            'result' => new FooterYearUpdateResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FooterYearUpdateMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FooterYearUpdateMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FooterYearUpdateError('boom', 'boom');
        $utility->fetcher = function (FooterYearUpdateContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FooterYearUpdateSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FooterYearUpdateMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FooterYearUpdateContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FooterYearUpdateMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FooterYearUpdateResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FooterYearUpdateMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FooterYearUpdateContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FooterYearUpdateSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FooterYearUpdateMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FooterYearUpdateResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FooterYearUpdateSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FooterYearUpdateMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FooterYearUpdateMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FooterYearUpdateMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FooterYearUpdateResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FooterYearUpdateDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FooterYearUpdateResult(['ok' => false])]);
        $this->expectException(FooterYearUpdateError::class);
        FooterYearUpdateDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FooterYearUpdateResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FooterYearUpdateMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FooterYearUpdateMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FooterYearUpdateBaseFeature();
        $b = new FooterYearUpdateBaseFeature();
        FooterYearUpdateFeatureAdd::call($ctx, $a);
        FooterYearUpdateFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FooterYearUpdateBaseFeature
    {
        $f = new FooterYearUpdateBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FooterYearUpdateFeatureAdd::call($ctx, self::named_feature('a'));
        FooterYearUpdateFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        FooterYearUpdateFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        FooterYearUpdateFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        FooterYearUpdateFeatureAdd::call($ctx, $replace);
        ...
        FooterYearUpdateFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FooterYearUpdateContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FooterYearUpdateSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FooterYearUpdatePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FooterYearUpdatePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FooterYearUpdateResponse(['headers' => null]),
            'result' => new FooterYearUpdateResult([]),
        ]);
        FooterYearUpdateResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FooterYearUpdateResultBody::call($ctx);
