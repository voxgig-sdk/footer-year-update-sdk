...
class YearEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FOOTER_YEAR_UPDATE_TEST_YEAR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function year_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FOOTER_YEAR_UPDATE_TEST_YEAR_ENTID");
