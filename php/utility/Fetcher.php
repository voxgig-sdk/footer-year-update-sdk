...
// FooterYearUpdate SDK utility: fetcher

class FooterYearUpdateFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FooterYearUpdateSDK/1.0)';
    ...
    public static function call(FooterYearUpdateContext $ctx, string $fullurl, array $fetchdef): array
    {
