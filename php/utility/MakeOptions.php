...
// FooterYearUpdate SDK utility: make_options

class FooterYearUpdateMakeOptions
{
    ...
    public static function call(FooterYearUpdateContext $ctx): array
    {
        ...
        //
        // `FooterYearUpdateSchema::optspec()` is built from the model:
        ...
        $optspec = FooterYearUpdateSchema::optspec();
