...
// FooterYearUpdate SDK netsim feature
...
class FooterYearUpdateNetsimFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _simulate(FooterYearUpdateContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FooterYearUpdateContext $ctx, array $applied): void
    {
        $client = $this->client;
