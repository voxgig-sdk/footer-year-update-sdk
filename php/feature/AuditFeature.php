...
// FooterYearUpdate SDK audit feature
...
class FooterYearUpdateAuditFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _emit(FooterYearUpdateContext $ctx, string $outcome): void
    {
