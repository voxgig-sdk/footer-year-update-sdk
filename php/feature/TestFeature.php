...
// FooterYearUpdate SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FooterYearUpdateTestFeature extends FooterYearUpdateBaseFeature
{
    ...
    public function init(FooterYearUpdateContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FooterYearUpdateContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FooterYearUpdateParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FooterYearUpdateContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FooterYearUpdateContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = FooterYearUpdateParam::call($ctx, $k);
