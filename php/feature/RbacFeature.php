...
// FooterYearUpdate SDK rbac feature
...
class FooterYearUpdateRbacFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _required(FooterYearUpdateContext $ctx): ?string
    {
    ...
    private function _reject(FooterYearUpdateContext $ctx, string $required): void
    {
    ...
    private function _track(FooterYearUpdateContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
