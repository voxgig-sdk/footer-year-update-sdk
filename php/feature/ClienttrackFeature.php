...
// FooterYearUpdate SDK clienttrack feature
...
class FooterYearUpdateClienttrackFeature extends FooterYearUpdateBaseFeature
{
    ...
    public function PostConstruct(FooterYearUpdateContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FooterYearUpdate-SDK';
