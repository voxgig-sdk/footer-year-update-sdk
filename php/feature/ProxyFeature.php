...
// FooterYearUpdate SDK proxy feature
...
class FooterYearUpdateProxyFeature extends FooterYearUpdateBaseFeature
{
    ...
    public function init(FooterYearUpdateContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FooterYearUpdateContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
