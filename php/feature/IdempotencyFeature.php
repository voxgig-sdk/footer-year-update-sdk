...
// FooterYearUpdate SDK idempotency feature
...
class FooterYearUpdateIdempotencyFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _mutating(FooterYearUpdateContext $ctx): bool
    {
