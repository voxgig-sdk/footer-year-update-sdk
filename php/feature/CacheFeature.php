...
// FooterYearUpdate SDK cache feature
...
class FooterYearUpdateCacheFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _through(FooterYearUpdateContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
