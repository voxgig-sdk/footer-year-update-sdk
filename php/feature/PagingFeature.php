...
// FooterYearUpdate SDK paging feature
...
class FooterYearUpdatePagingFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _is_list(FooterYearUpdateContext $ctx): bool
    {
