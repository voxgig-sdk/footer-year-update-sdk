...
// FooterYearUpdate SDK timeout feature
...
class FooterYearUpdateTimeoutFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _with_timeout(FooterYearUpdateContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FooterYearUpdateContext $_ctx, float $ms): void
    {
        $client = $this->client;
