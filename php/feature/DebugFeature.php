...
// FooterYearUpdate SDK debug feature
...
class FooterYearUpdateDebugFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _finish(FooterYearUpdateContext $ctx, bool $ok): void
    {
