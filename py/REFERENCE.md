# FooterYearUpdate Python SDK Reference

Complete API reference for the FooterYearUpdate Python SDK.
...
#### `FooterYearUpdateSDK.test(testopts=None, sdkopts=None)`
...
| --- | --- | --- | --- |
| `sponsored_by` | `str` | Yes | Sponsored message (required to be displayed/logged per Terms of Service for free tier users) |
| `year` | `int` | Yes | The current year as an integer |
| `year_string` | `str` | Yes | The current year as a string |
