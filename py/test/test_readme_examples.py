# FooterYearUpdate SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FooterYearUpdateSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FooterYearUpdateSDK(...) and FooterYearUpdateSDK.test(...) become
#      FooterYearUpdateSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "footeryearupdate_sdk"
_SDK_CLASS = "FooterYearUpdateSDK"
