...
from footeryearupdate_sdk.footeryearupdate_types import (
    Year,
    YearLoadMatch,
)
...
class YearEntity:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Year:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Year().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
