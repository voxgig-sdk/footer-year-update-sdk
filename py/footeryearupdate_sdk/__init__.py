...
from footeryearupdate_sdk.utility import register

# Load features
from footeryearupdate_sdk.feature.base_feature import FooterYearUpdateBaseFeature
from footeryearupdate_sdk.features import _has_feature, _make_feature
...
class FooterYearUpdateSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FooterYearUpdateUtility()
    ...
    def get_utility(self):
        return FooterYearUpdateUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FooterYearUpdateSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Year(self, data=None) -> "YearEntity":
        ...
        from footeryearupdate_sdk.entity.year_entity import YearEntity
