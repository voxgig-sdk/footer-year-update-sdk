...
func registerSDKWords(r *eng.Registry, client *sdk.FooterYearUpdateSDK) {
...
func runOp(client *sdk.FooterYearUpdateSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
