...
AQL-driven CLI and REPL for the FooterYearUpdate SDK. Positional arguments are
...
```sh
go build -o footer-year-update-cli ./...
```
...
./footer-year-update-cli list year
./footer-year-update-cli load 1 year
./footer-year-update-cli load '{id:1}' year
