...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/footer-year-update` | `npm install @voxgig-sdk/footer-year-update` |
| Python | `voxgig-sdk-footer-year-update` | `pip install voxgig-sdk-footer-year-update` |
| PHP | `voxgig-sdk/footer-year-update` | `composer require voxgig-sdk/footer-year-update` |
| Golang | `github.com/voxgig-sdk/footer-year-update-sdk/go` | `go get github.com/voxgig-sdk/footer-year-update-sdk/go` |
| Ruby | `voxgig-sdk-footer-year-update` | `gem install voxgig-sdk-footer-year-update` |
| Lua | `voxgig-sdk-footer-year-update` | `luarocks install voxgig-sdk-footer-year-update` |
