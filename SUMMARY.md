...
Results: Successful response with current year information.
...
| --- | --- | --- | --- |
| Year | `load` | `GET /year` | See reference |

## Connect to the API

- Production API Server: `https://getfullyear.com/api`
...
- `footer-year-update_list`: List records for an entity. No active entity supports this operation.
- `footer-year-update_load`: Load one record for an entity. Supported entities: `year`.
