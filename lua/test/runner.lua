...
function runner.env_override(m)
  local live = runner.getenv("FOOTER_YEAR_UPDATE_TEST_LIVE")
  local override = runner.getenv("FOOTER_YEAR_UPDATE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FOOTER_YEAR_UPDATE_TEST_EXPLAIN")
