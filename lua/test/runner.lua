...
function runner.env_override(m)
  local live = runner.getenv("FOOTERYEARUPDATE_TEST_LIVE")
  local override = runner.getenv("FOOTERYEARUPDATE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FOOTERYEARUPDATE_TEST_EXPLAIN")
