...
describe("YearDirect", function()
  it("should direct-load-year", function()
    local setup = year_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-year", setup.live and "live" or "unit")
