...
func yearBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FOOTER_YEAR_UPDATE_TEST_YEAR_ENTID")
	...
	idmapResolved := core.ToMapAny(env["FOOTER_YEAR_UPDATE_TEST_YEAR_ENTID"])
	if idmapResolved == nil {
		idmapResolved = core.ToMapAny(idmap)
	}

	if env["FOOTER_YEAR_UPDATE_TEST_LIVE"] == "TRUE" {
