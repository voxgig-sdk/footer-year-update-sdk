...
type YearEntity struct {
	name    string
	client  *core.FooterYearUpdateSDK
...
func NewYearEntity(client *core.FooterYearUpdateSDK, entopts map[string]any) *YearEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *YearEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// YearLoadMatch and returns an Year. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *YearEntity) LoadTyped(reqmatch YearLoadMatch, ctrl map[string]any) (Year, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Year{}, err
	}
	return typedFrom[Year](res), nil
}
