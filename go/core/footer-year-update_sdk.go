...
type FooterYearUpdateSDK struct {
	Mode     string
...
func (sdk *FooterYearUpdateSDK) OptionsMap() map[string]any {
...
func (sdk *FooterYearUpdateSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FooterYearUpdateSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FooterYearUpdateSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FooterYearUpdateSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FooterYearUpdateSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FooterYearUpdateSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FooterYearUpdateSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FooterYearUpdateSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FooterYearUpdateSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FooterYearUpdateSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FooterYearUpdateSDK {
	...
	sdk := NewFooterYearUpdateSDK(sdkopts)
	sdk.Mode = "test"
