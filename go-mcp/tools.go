...
type Args struct {
	Entity string         `json:"entity" jsonschema:"year"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FooterYearUpdateSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "footer-year-update_list",
		Description: "List records from FooterYearUpdate. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "footer-year-update_load",
		Description: "Load a single record from FooterYearUpdate. " +
...
func runOp(client *sdk.FooterYearUpdateSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FooterYearUpdateSDK, name string) (sdk.FooterYearUpdateEntity, error) {
