// Command FooterYearUpdate-mcp is an MCP server exposing the FooterYearUpdate
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FooterYearUpdate_list  — list records of an entity
//	FooterYearUpdate_load  — load a single record of an entity
//
