...
from projectname_sdk.core.control import FooterYearUpdateControl
...
class FooterYearUpdateContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FooterYearUpdateControl()
        ...
        if isinstance(sp, FooterYearUpdateSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FooterYearUpdateResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FooterYearUpdateResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return FooterYearUpdateOperation({})
    ...
    def make_error(self, code, msg):
        return FooterYearUpdateError(code, msg, self)
