...
// FooterYearUpdate SDK utility: graphql
//
...
class FooterYearUpdateGraphql
{
    ...
    // equivalent.
    public static function body(FooterYearUpdateContext $ctx): mixed
    {
    ...
    public static function errors(FooterYearUpdateContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
