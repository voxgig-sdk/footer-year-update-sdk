...
// FooterYearUpdate SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FooterYearUpdateMakeRequest
{
    public static function call(FooterYearUpdateContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FooterYearUpdateResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FooterYearUpdateResponse($fetched);
        } else {
