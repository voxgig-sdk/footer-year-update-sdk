...
// FooterYearUpdate SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FooterYearUpdateTransformResponse
{
    public static function call(FooterYearUpdateContext $ctx): mixed
    {
        ...
        $transform = FooterYearUpdateHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
