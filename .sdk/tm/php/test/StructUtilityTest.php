...
// FooterYearUpdate SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FooterYearUpdateOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FooterYearUpdateOmni::structfix($now, Struct::undef()))
                        !== json_encode(FooterYearUpdateOmni::structfix($val, Struct::undef()))) {
