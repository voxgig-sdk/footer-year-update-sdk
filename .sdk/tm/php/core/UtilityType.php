...
// FooterYearUpdate SDK utility type

class FooterYearUpdateUtility
{
    ...
    public static function copy(FooterYearUpdateUtility $src): FooterYearUpdateUtility
    {
        $u = new FooterYearUpdateUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
