...
// FooterYearUpdate SDK ratelimit feature
...
class FooterYearUpdateRatelimitFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _acquire(FooterYearUpdateContext $ctx): void
    {
    ...
    private function _track(FooterYearUpdateContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
