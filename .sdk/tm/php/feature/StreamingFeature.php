...
// FooterYearUpdate SDK streaming feature
...
class FooterYearUpdateStreamingFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _iterate(FooterYearUpdateResult $result): \Generator
    {
    ...
    private function _streamable(FooterYearUpdateContext $ctx): bool
    {
