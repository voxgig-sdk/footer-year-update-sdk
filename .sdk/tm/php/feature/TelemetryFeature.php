...
// FooterYearUpdate SDK telemetry feature
...
class FooterYearUpdateTelemetryFeature extends FooterYearUpdateBaseFeature
{
    ...
    private function _close(FooterYearUpdateContext $ctx, bool $ok): void
    {
