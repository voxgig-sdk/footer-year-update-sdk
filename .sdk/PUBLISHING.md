...
|---|---|---|
| `ts/` | @voxgig-sdk/footer-year-update-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/footer-year-update-sdk \
      --repository voxgig-sdk/footer-year-update-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/footer-year-update-sdk` shows it, and
`npm trust revoke @voxgig-sdk/footer-year-update-sdk --id=<id>` removes it.
